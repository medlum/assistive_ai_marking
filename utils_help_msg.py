...
ai_temperature_msg =  "The temperature parameter in an AI model controls the randomness or creativity of the output. Lower temperature (e.g., 0.1 or 0): More deterministic and focused. The model plays it safe and chooses the most likely next word. Higher temperature (e.g., 0.8 or 1.0): More creative and varied. The model takes more risks and is more likely to pick less common words."